---
title: "AI開発でユーザーの判断軸が効いた1日 — Day051 振り返り"
emoji: "🤝"
type: "idea"
...
### 5. Day のキックオフでアラインメント不足を指摘

blue/green 実装 Day を開始するとき、Claude はすぐに実装に走ろうとした。結果、サブセッション側で rolling update を提案してきて、やり直し。「新しい Day、特に設計判断が多いタスクでは、10-15 分のアラインメント会議を先に挟んで 6-8 個の論点を詰めてから走る」というルールにした。
...
- ALB listener rule に host_header 条件がなく他サービスに吸い込まれるリスク
